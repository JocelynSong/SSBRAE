...
[optimizer]
optimizer=SGD
lr=%f""" % (dim, weight_rec, weight_sem, weight_l2, alpha, seed, batch, min_count, lr)

conf_name = "conf/dim%d_lrec%f_lsem%f_lword%f_alpha%f_seed%d_batch%d_min%d_lr%f.config" % (
dim, weight_rec, weight_sem, weight_l2, alpha,
seed, batch, min_count, lr)
