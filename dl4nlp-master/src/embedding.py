...
from src.utils import shared_rand_matrix, shared_matrix
...
class WordEmbedding(Embedding):
    def __init__(self, word_idx, dim=50, filename=None, initializer=default_initializer,
        ...
        if filename is None:
            ...
            w, dim = self.read_wordvec(filename, self.word_idx, binary=binary,
    ...
    def read_wordvec(self, filename, word_idx, binary=True, add_unknown_word=True, encoding="utf8",
                     unicode_errors='strict'):
